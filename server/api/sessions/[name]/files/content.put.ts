...
import { saveFileBodySchema } from '#shared/contracts/api'
...
export default defineEventHandler(async (event) => {
  ...
  const body = await readRequestBody(event, saveFileBodySchema)
  ...
  try {
    ...
    throw createError({
      statusCode: 500,
      statusMessage: 'Failed to write file content.',
      data: msg,
    })
  }
})
